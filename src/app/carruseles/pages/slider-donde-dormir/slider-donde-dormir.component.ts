...
@Component({
  ...
  templateUrl: './slider-donde-dormir.component.html',
  styleUrls: ['./slider-donde-dormir.component.css']
})
export class SliderDondeDormirComponent implements OnInit {

    private destroy$ = new Subject<void>();
    allowedSizeGallery: number = 150; //kilo bytes
    cambiosConfirmados: boolean = false;
    datosInvalidos: boolean = true;
    directorio: string = 'donde_dormir'; //subcarpeta con el nombre del lugar

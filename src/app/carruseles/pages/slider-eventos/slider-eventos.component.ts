...
@Component({
  selector: 'app-slider-eventos',
  templateUrl: './slider-eventos.component.html',
  styleUrls: ['./slider-eventos.component.css']
})
export class SliderEventosComponent implements OnInit {

    private destroy$ = new Subject<void>();
    allowedSizeGallery: number = 150; //kilo bytes
    cambiosConfirmados: boolean = false;
    datosInvalidos: boolean = true;
    directorio: string = 'eventos'; //subcarpeta con el nombre del lugar
    ...
    page: number = 1;
    sliders: Slider[] = [];
    titulo: string = 'Carrusel Eventos'

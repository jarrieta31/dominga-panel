...
@Component({
    ...
    templateUrl: './slider-donde-comer.component.html',
    styleUrls: ['./slider-donde-comer.component.css']
})
export class SliderDondeComerComponent implements OnInit {

    private destroy$ = new Subject<void>();
    allowedSizeGallery: number = 150; //kilo bytes
    cambiosConfirmados: boolean = false;
    datosInvalidos: boolean = true;
    directorio: string = 'donde_comer'; //subcarpeta con el nombre del lugar
